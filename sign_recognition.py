...
namee = Label(win,text='Hanuma', font=('Verdana',14,'bold'),relief=GROOVE,width = 22,bd=5, fg="#F5EAEA", bg="#20262E")
...
def select_img():
        ...
        # image = Image.open(cv2.imencode('.png', framergb)[1].tobytes())  # Alternative approach
        image = Image.fromarray(np.array(framergb, dtype=np.uint8)) 
